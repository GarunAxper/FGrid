...
namespace FGrid.Persistence.Models
{
    ...
    /// </summary>
    public abstract class FGridRow
    {
        /// <summary>
        /// Set the ID property of the dt-tag tr node to this value
        /// </summary>
        [JsonProperty("DT_RowId")]
        public virtual string FGridRowId => null;

        /// <summary>
        /// Add this class to the dt-tag tr node
        /// </summary>
        [JsonProperty("DT_RowClass")]
        public virtual string FGridRowClass => null;
        ...
        public virtual object FGridRowData => null;
        ...
        public virtual object FGridRowAttr => null;
    }
    ...
    public class FGridModel
    {
        ...
        /// </summary>
        public FGridOrder[] Order { get; set; }
        ...
        /// </summary>
        public FGridSearch Search { get; set; }
        ...
        public string SortOrder => Columns != null && Order != null && Order.Length > 0
            ? (Columns[Order[0].Column].Data +
               (Order[0].Dir == FGridOrderDir.Desc ? " " + Order[0].Dir : string.Empty))
            : null;
    ...
    public class FGridOrder
    {
        ...
        /// </summary>
        public FGridOrderDir Dir { get; set; }
    }

    /// <summary>
    /// Sort orders of jQuery DataTables.
    /// </summary>
    public enum FGridOrderDir
    {
        Asc,
        Desc
    }
